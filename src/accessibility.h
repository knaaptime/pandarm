...
namespace MTC
{
    namespace accessibility
    {
        ...
        public:
            ...
            // shortest path between two point64_ts
            ...
            // shortest path distance between two point64_ts
        ...
        private:
            ...
            // accessibility_vars_t is a vector of floating point64_t values
            ...
            // set to one, but I can imagine using floating point64_t values
